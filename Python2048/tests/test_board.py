...
class TestBoard(unittest.TestCase):
    ...
    def test_init_dimensions_3_goal_4(self):
        ...
        self.assertEqual(b.board_size(), 3)
    ...
    def test_size(self):
        s = 42
        b = Board(size=s)
        self.assertEqual(b.board_size(), s)

    # == .goal == #
    def test_goal(self):
        g = 17
        b = Board(goal=g)
        self.assertEqual(b.board_goal(), g)
    ...
    def test_getCell(self):
        ...
        v = 42
        self.b.cells[y][x] = v
        self.assertEqual(self.b.get_cell(x, y), v)

    # == .setCell == #
    def test_setCell(self):
        x, y = 2, 3
        v = 42
        self.b.set_cell(x, y, v)
    ...
    def test_getLine(self):
        ...
        self.assertSequenceEqual(b.get_line(1), l)
    ...
    def test_setLine(self):
        ...
        l = [1, 2, 3, 4]
        self.b.set_line(i, l)
        self.assertEqual(self.b.get_line(i), l)
    ...
    def test_setCol(self):
        ...
        l = [1, 2, 3, 4]
        self.b.set_col(i, l)
        self.assertEqual(self.b.get_col(i), l)

    # == .getEmptyCells == #
    def test_get_empty_cells(self):
        self.assertEqual(len(self.b.get_empty_cells()), Board.SIZE**2 - 2)

    def test_get_empty_cells_filled(self):
        b = Board(size=1)
        b.set_cell(0, 0, 42)
        self.assertSequenceEqual(b.get_empty_cells(), [])
    ...
    def test_move_dont_add_tile_if_nothing_move2(self):
        ...
        self.assertEqual(b.get_line(0), [8, 4, 4, 2])
        self.assertEqual(b.get_line(1), [0, 2, 2, 0])
    ...
    def test_move_collapse_chain_col(self):
        ...
        self.assertSequenceEqual(b.get_col(0), [0, 0, 4, 4])
    ...
    def test_move_collapse_chain_line_right(self):
        ...
        self.assertSequenceEqual(b.get_line(0), [0, 0, 4, 4])
    ...
    def test_move_collapse_chain_line_left(self):
        ...
        self.assertSequenceEqual(b.get_line(0), [4, 4, 0, 0])
