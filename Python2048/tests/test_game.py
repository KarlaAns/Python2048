...
class TestGame(unittest.TestCase):
    ...
    def test_init_with_size_3_goal_4(self):
        ...
        self.assertEqual(g.board.board_size(), 3)
    ...
    def test_store_restore_empty_game(self):
        ...
        g2.board.set_cell(0, 0, 16)
        self.assertTrue(g2.restore())
        self.assertIn(g2.board.get_cell(0, 0), [0, 2, 4])
        remove(store.name)
